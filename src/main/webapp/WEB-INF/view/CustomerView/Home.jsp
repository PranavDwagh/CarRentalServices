  ...
  <div class="site-wrap" id="home-section">
    ...
    <header class="site-navbar site-navbar-target" role="banner">
      ...
      <div class="container">
       ...
       <div class="container" style="align-self: center; padding-top: 12%; padding-left: 10%; padding-bottom: 0%; padding-right: 10%;">
        ...
        <form>  
                        ...
                        <div class="row">
                          <div class="booking-form">
                            <div class="form-header">
                              <h1>Book a car</h1>
                              <h2 style="color: white;">Fast &amp; Easy Way To Rent A Car</h2>
                            </div>
                            <form>
                              <div class="row">
                              ...
                              <div class="form-group">
                                ...
                                <select style="height: 40px;" class="form-control" id="country-state" name="country-state">
                              ...
                              <div class="form-group">
                                ...
                                <select style="height: 40px;" class="form-control" id="country-state" name="country-state">
                                  ...
                                  <option value="AN">Hinjewadi</option>
                                  <option value="AP">Kothrud</option>
                                  <option value="AR">Nigdi</option>
                                  <option value="AS">Lohgaon</option>
                                  <option value="BR">Shivajinagar</option>
                                  <option value="CH">wakad</option>
                                  <option value="CT">Pimpri-Chinchwad</option>
                                  <option value="DN">wagholi</option>
                                  <option value="DD">Baner</option>
                                  <option value="DL">Chandani Chowk</option>
                                  <option value="GA">warje</option>
                                  <option value="GJ">Narhe</option>
                              </select>
                              </div>
                              <div class="row">
                                <div class="col-sm-5">
          ...
          <div class="form-btn " style="padding-left:37%;">
                                <a href="carlist.html" class="btn btn-">Rent A Car Now</a>
                              </div>
      </form>
  </div>
